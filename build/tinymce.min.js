...
!(function () {
  ...
  const Ct = () => yt(),
    ...
    Ot = function (e, t, n, o) {
      ;(o = o || this),
        e && (n && (e = e[n]), Ne(e, (e, r) => !1 !== t.call(o, e, r, n) && (Ot(e, t, n, o), !0)))
    },
    Tt = {
      trim: At,
      isArray: Ee,
  ...
  const Lt = (e) => e.dom.nodeName.toLowerCase(),
    ...
    vo = (e, t, n, o) => ({x: e, y: t, width: n, height: o, right: e + n, bottom: t + o}),
    yo = (e) => {
  ...
  const Ao = (e) => (t) => !!t && t.nodeType === e,
    ...
    Br = (e) => {
      const t = e.container()
      return (
        !!zo(t) && (t.data.charAt(e.offset()) === kr || (e.isAtStart() && Ar(t.previousSibling)))
      )
    },
    Dr = (e) => {
      const t = e.container()
          ...
          (e, t) =>
            ((e) => -1 !== ' \f\t\v'.indexOf(e))(t) || t === tr
              ? e.pcIsSpace ||
                ...
                ((e, t) => t < e.length && t >= 0 && Qr(e[t]))(s, e.str.length + 1)
        ...
        i = (i) =>
          new Promise((l, d) => {
            ...
            const u = Tt._addCacheSuffix(i),
              m = ((e) =>
                we(o, e).getOrThunk(() => ({id: 'mce-u' + n++, passed: [], failed: [], count: 0})))(
                u
              )
            ;(o[u] = m), m.count++
            const f = (e, t) => {
          ...
          if (t) {
            ...
            for (
              ...
              let t = s[1].replace(r, '').toLowerCase(),
                l = s[2].replace(r, '')
              if (t && l) {
                if (((t = h(t)), (l = h(l)), -1 !== t.indexOf('\ufeff') || -1 !== t.indexOf('"')))
                  continue
                if (
                  !e.allow_script_urls &&
                ...
                'font-weight' === t && '700' === l
                  ? (l = 'bold')
                  : ('color' !== t && 'background-color' !== t) || (l = l.toLowerCase()),
                  (l = l.replace(n, b)),
                  (a[t] = i ? g(l, !0) : l)
              }
            }
        ...
        if (t) {
          ...
          for (; s--; ) {
            ...
            if (a) {
              ...
              ;(n && 0 !== a.length) ||
                (delete r[t], ra(e, a.fakeName || t, a.nativeHandler, a.capture))
            }
          }
        } else
          fe(r, (t, n) => {
  ...
  const la = Tt.each,
    ...
    ha = (e, t, n) => {
      ...
      y(n) || '' === n
        ? Xn(e, o)
        : Vn(e, o, ((e, t) => (x(e) ? (xe(ua, t) ? e + '' : e + 'px') : e))(n, o))
    },
    ba = (e, t = {}) => {
      const n = {},
        o = window,
    ...
    _a = () => {
      ...
      return {
        ...
        load: (e, o) => {
          ...
          0 !== s.indexOf('/') && -1 === s.indexOf('://') && (s = _a.baseURL + '/' + s),
  ...
  const Ha = (e) => {
    ...
    Xa = (e, t) => (
      (e = Ya(e)), t || (e.left = e.left + e.width), (e.right = e.left), (e.width = 0), e
    ),
          ...
          (n = ((e) => {
            const t = [],
              ...
              o = (e, t) => {
                ...
                if (t < e.data.length) {
                  ...
                  if (ri(e.data[t - 1]) && (o.setStart(e, t), o.setEnd(e, t + 1), !vi(o)))
                    return void n(wi(Ci(o), !1))
                }
                t > 0 && (o.setStart(e, t - 1), o.setEnd(e, t), vi(o) || n(wi(Ci(o), !1))),
                  t < e.data.length &&
                    (o.setStart(e, t), o.setEnd(e, t + 1), vi(o) || n(wi(Ci(o), !0)))
              },
              r = e.container(),
              s = e.offset()
            ...
            if (si(r))
              if (e.isAtEnd()) {
                ...
                di(i) && !mi(i) && (ii(i) || ii(a) || !di(a)) && n(wi(Ci(i), !1)),
                  di(a) && n(wi(Ci(a), !0))
              }
            return t
          })(xi(e, t))),
  ...
  ;(xi.fromRangeStart = (e) => xi(e.startContainer, e.startOffset)),
    ...
    (xi.isAbove = (e, t) => Dt(ie(t.getClientRects()), le(e.getClientRects()), Ja).getOr(!1)),
    (xi.isBelow = (e, t) => Dt(le(t.getClientRects()), ie(e.getClientRects()), Za).getOr(!1)),
  ...
  const ki = (e, t) => {
    ...
    Ai = (e) =>
      e
        ? Oe(
            e.childNodes,
            (e, t) => (Ei(t) && 'BR' !== t.nodeName ? (e = e.concat(Ai(t))) : e.push(t), e),
            []
          )
        : [],
    Oi = (e) => (t) => e === t,
    ...
    Bi = (e, t) => {
      ...
      return (
        (a = Ae(a, T(Mo))), (o = o.concat(Re(a, (e) => Ti(e)))), o.reverse().join('/') + ',' + n
      )
    },
    Di = (e, t) => {
      if (!t) return null
        ...
        i.push(
          n
            ? ((e, t, n) => {
                ...
                for (let n = t.previousSibling; n && zo(n); n = n.previousSibling)
                  o += e(n.data).length
                return o
              })(t, s, a)
            : a
    ...
    Wi = {value: Vi, error: qi, fromOption: (e, t) => e.fold(() => qi(t), Vi)},
    Ki = (e) => {
  ...
  const Dc = Yo,
    ...
    Ic = Wr,
    Fc = (e) =>
      $r(e) || ((e) => !!Kr(e) && !Y(de(e.getElementsByTagName('*')), (e, t) => e || Fr(t), !1))(e),
    Uc = Gr,
    ...
    Hc = (e, t, n) => {
      ...
      if (t.isEqual(xi.after(n)) && n.lastChild) {
        if (((a = xi.after(n.lastChild)), pc(e) && Ic(n.lastChild) && Lc(n.lastChild)))
    ...
    Gc = (e, t, n) =>
      Kc(e, t, n).bind((o) =>
        ...
        ((e, t, n) => {
          return e
            ? !Wc(t, n) && ((o = t), !(!xi.isTextPosition(o) && Wo(o.getNode()))) && qc(t) && Vc(n)
            : !Wc(n, t) && Vc(t) && qc(n)
          var o
        })(e, n, o)
          ? Kc(e, t, o)
    ...
    iu = (e, t) => (
      To(t) && e.isBlock(t) && !t.innerHTML && (t.innerHTML = '<br data-mce-bogus="1" />'), t
    ),
    lu = (e, t) =>
      eu(e).fold(
        P,
  ...
  const bu = (e) => '' !== e && -1 !== ' \f\n\r\t\v'.indexOf(e),
    ...
    ju = (e, t) => {
      ...
      if (
        ...
        if (a < i.length) {
          ...
          ;(d = new Ro(t, null !== (o = e.getParent(t, e.isBlock)) && void 0 !== o ? o : l)),
            d.next(!0)
        }
    ...
    Qu = (e, t) => {
      ...
      return (
        e.getParent(
          t,
          (t) => !!To(t) && ((n = e.getStyle(t, 'text-decoration')), !!n && 'none' !== n)
        ),
        n
      )
    },
    ...
    mm = (e, t, n, o, r, s) => {
      ...
      return l(n, o, cm)
        .bind((e) => (s ? l(e.container, e.offset + (r ? -1 : 0), um) : M.some(e)))
    ...
    fm = (e, t, n, o, r) => {
      ...
      for (let o = 0; o < a.length; o++)
        for (let r = 0; r < t.length; r++) {
          const s = t[r]
          if ((!C(s.collapsed) || s.collapsed === n.collapsed) && tm(s) && e.is(a[o], s.selector))
            return a[o]
        }
      return o
    },
    ...
    hm = (e, t, n, o, r) => {
      ...
      for (; s; ) {
        ...
        for (let t = s[a]; t; t = t[a]) {
          ...
          if (
            !rm(t) &&
            (!Wo((l = t)) || !l.getAttribute('data-mce-bogus') || l.nextSibling) &&
            !am(t, n)
          )
            return s
        }
    ...
    vm = (e, t, n, o = !1) => {
      ...
      return (
        ...
        t.collapsed &&
          (mm(e, e.getRoot(), r, s, !0, o).each(({container: e, offset: t}) => {
            ;(r = e), (s = t)
          }),
        ...
        om(l) && ((r = fm(e, n, t, r, 'previousSibling')), (a = fm(e, n, t, a, 'nextSibling'))),
        (em(l) || tm(l)) &&
          ((r = gm(e, n, r, 'previousSibling')),
          (a = gm(e, n, a, 'nextSibling')),
          em(l) &&
            (e.isBlock(r) || (r = hm(e, n, r, s, !0)), e.isBlock(a) || (a = hm(e, n, a, i, !1)))),
      ...
      const x = (e) => C(e) && (Ko(e) || n.is(e, 'figure.image')),
        ...
        A = (e) => {
          ...
          ;(o = e.screenX - u),
            ...
            (b = b < 5 ? 5 : b),
            (v = v < 5 ? 5 : v),
            (c = (x(a) || k(a)) && !1 !== Hl(t) ? !Dm.modifierPressed(e) : Dm.modifierPressed(e)),
            c &&
              (Lm(o) > Lm(r)
                ? ((v = Mm(b * p)), (b = Mm(v / p)))
                : ((b = Mm(v / p)), (v = Mm(b * p)))),
        ...
        L = (o) => {
          ...
          const r = 'mousedown' === o.type ? o.target : e.getNode(),
            a = Eo(mn(r), 'table,img,figure.image,hr,video,span.mce-preview-object')
              .map((e) => e.dom)
              .getOrUndefined(),
  ...
  const $m = (e, t, n, o) => ({start: e, soffset: t, finish: n, foffset: o}),
    Vm = document.caretPositionFromPoint
      ...
      : M.none,
    qm = Ki([{before: ['element']}, {on: ['element', 'offset']}, {after: ['element']}]),
    Wm = {
      before: qm.before,
      on: qm.on,
      after: qm.after,
        ...
        return ((e, t) => {
          ...
          return n.collapsed
            ? t
                ...
                .map((e) =>
                  jm.rtl(mn(e.endContainer), e.endOffset, mn(e.startContainer), e.startOffset)
                )
      ...
      ((e, t, n) =>
        ((e, t, n) => {
          ...
          return Vm(o, t, n).map((e) =>
            $m(mn(e.startContainer), e.startOffset, mn(e.endContainer), e.endOffset)
          )
    ...
    af = (e, t, n, o, r) => {
      ...
      for (; (d = u[o ? 'prev' : 'next']()); ) {
        ...
        if (zo(d) && d.data.length > 0)
          return of(d, s, 'A') ? M.none() : M.some(xi(d, o ? d.data.length : 0))
    ...
    lf = (e, t, n, o) => {
      ...
      if (
        (To(i) && l > i.childNodes.length - 1 && (u = !1), Vo(i) && ((i = r), (l = 0)), i === r)
      ) {
  ...
  var hf = Object.freeze({
    ...
    view: (e) => {
      ...
      return (
        e.dom === document
          ? M.none()
          : M.from(null === (t = e.dom.defaultView) || void 0 === t ? void 0 : t.frameElement)
      ).map(mn)
    },
    owner: (e) => Cn(e),
  })
  ...
  const Kf = ba.DOM,
    Gf = (e, t) => {
      const n = td(e),
        o = Kf.getParent(
          t,
          (t) => ((e) => To(e) && Vf.isEditorUIElement(e))(t) || (!!n && e.dom.is(t, n))
        )
      return null !== o
    },
    Yf = (e, t) => {
    ...
    Xf = (e, t) => {
      e.focusedEditor === t.editor && (e.focusedEditor = null),
        !e.activeEditor && Wf && (Kf.unbind(document, 'focusin', Wf), (Wf = null))
    },
    Qf = (e, t) => {
      ;((e, t) =>
        ((e) => (e.collapsed ? M.from(ni(e.startContainer, e.startOffset)).map(mn) : M.none()))(
          t
        ).bind((t) => (pr(t) ? M.some(t) : vn(e, t) ? M.none() : M.some(e))))(mn(e.getBody()), t)
        .bind((e) => Zc(e.dom))
        .fold(
          () => {
      ...
      e.inline
        ? ((e) => {
            ...
            return (
              t &&
              ((n = mn(t)),
              Pf(n) || ((o = n), Lf(In(o)).filter((e) => o.dom.contains(e.dom))).isSome())
            )
            var n, o
          })(e)
  ...
  const Ng = ['font', 'text-decoration', 'text-emphasis'],
    ...
    Vg = Pg(!1, Mg),
    qg = (e, t) =>
      ((e, t, n) => (vn(t, e) ? Sn(e, (e) => n(e) || bn(e, t)).slice(0, -1) : []))(e, t, P),
    ...
    up = (e) =>
      Ac(e)
        .bind((e) => ko(e, Ft))
        .exists((e) => ((e) => j(['pre', 'pre-wrap'], e))(Wn(e, 'white-space'))),
    mp = (e, t) => (n) => {
    ...
    yp = (e, t, n) => {
      ...
      return n || !hp(o, o.length - 1) || pp(e, r)
        ? !!(n && bp(o, o.length - 1) && gp(e, r)) && ((t.data = o.slice(0, -1) + tr), !0)
          ...
          ((e) => {
            const t = e.data,
              n = ((e) => {
                const t = e.split('')
                return $(t, (e, n) =>
                  hu(e) && n > 0 && n < t.length - 1 && vu(t[n - 1]) && vu(t[n + 1]) ? ' ' : e
                ).join('')
              })(t)
    ...
    Ep = (e) => {
      return Wr(e.previousSibling)
        ? M.some(((t = e.previousSibling), zo(t) ? xi(t, t.data.length) : xi.after(t)))
        : e.previousSibling
        ...
        e
          ? ((e, t) =>
              Np(t)
                .orThunk(() => Ep(t))
                .orThunk(() =>
                  ((e, t) => Qc(e, xi.after(t)).orThunk(() => Jc(e, xi.before(t))))(e, t)
                ))(t, n)
          : ((e, t) =>
              Ep(t)
                .orThunk(() => Np(t))
      ...
      const i = ((e, t, n) => {
        ...
        return (
          ...
          s.isSome() && a.isSome() && i.isSome()
            ...
            : M.none()).orThunk(
            () => (n && (o.each((e) => kp(e.dom, e.dom.length)), r.each((e) => xp(e.dom, 0))), t)
          )
        )
        var s, a, i, l
    ...
    Jp = (e) => (t) =>
      Qp(t, e).map((e) => ((e, t, n) => ({rng: e, table: t, cells: n}))(t, e, Wp(e))),
    Zp = (e, t, n, o) => {
    ...
    eh = (e, t) => J(e, (e) => bn(e, t)),
    th = (e) =>
      Dt(eh(e.cells, e.rng.start), eh(e.cells, e.rng.end), (t, n) => e.cells.slice(t, n + 1)),
    nh = (e, t) => {
    ...
    ah = (e) => {
      ...
      Xo(n.dom) && os(n) ? e.selection.setCursorLocation(n.dom, 0) : e.selection.collapse(!0),
        ...
        const o = e.selection.getRng(),
          r = n
            .bind(({rng: n, isStartInTable: r}) => {
              const s = ((e, t) => M.from(e.dom.getParent(t, e.dom.isBlock)).map(mn))(
                e,
              ...
              os(o)
                ...
                : ((e, t, n, o, r) =>
                    Gc(n, e.getBody(), r).bind((e) =>
                      uh(t, mn(e.getNode())).bind((e) => (bn(e, o) ? M.none() : M.some(S)))
                    ))(e, n, t, o, r)
            )
          })(e, t, o, n).orThunk(() =>
            Pt(
            ...
            return 0 !== n.length
              ...
              : ((e, t, n, o) =>
                  mh(t, o).fold(
                    () =>
                      ((e, t, n) =>
                        oh(t, n).bind((t) => t.fold(O(dh, e), O(ch, e), O(ih, e), O(lh, e))))(
                        e,
                        t,
                        n
                      ),
    ...
    Rh = (e, t, n = S) => {
      ...
      for (let l = 0; l < e.length; l++) {
        ...
        if (o[d.name] && 'li' === d.parent.name) {
          let e = d.next
          for (; e && o[e.name]; )
            (e.name = 'li'), i.add(e), d.parent.insert(e, d.parent), (e = e.next)
          d.unwrap()
          continue
        }
        const f = [d]
        ...
        if (c && f.length > 1)
          if (t.isValidChild(c.name, d.name)) {
            ...
            Eh(t, r, s, u) ? c.insert(d, f[0], !0) : (c.insert(u, f[0], !0), c.insert(d, u)),
              (c = f[0]),
      ...
      m === f &&
        ...
        s.isCollapsed() ||
          ((e) => {
            ...
            ;((e, t, n) => !!C(n) && n === e.getParent(t.endContainer, Ih) && Bu(mn(n), t))(t, n, o)
              ? dh(e, n, mn(o))
    ...
    eb = (e) => {
      const t = cn('span')
      return (
        qt(t, {id: tu, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret'}),
        e && eo(t, un(Qh)),
        t
      )
    },
    ...
    nb = (e, t, n = !0) => {
      const o = e.dom,
        r = e.selection
      if (t) tb(e, t, n)
      else if (!(t = ou(e.getBody(), r.getStart()))) for (; (t = o.get(tu)); ) tb(e, t, !1)
    },
  ...
  const db = ['fontWeight', 'fontStyle', 'color', 'fontSize', 'fontFamily'],
    ...
    mb = (e, t) =>
      !1 === Qc(t, xi.fromRangeEnd(e)).exists((e) => !Wo(e.getNode()) || Qc(t, e).isSome()),
    ...
    Rb = (e, t, n) => {
      ...
      return (
        zo(o) && n && r >= o.data.length && (o = new Ro(o, e.getBody()).next() || o),
    ...
    Bb = (e, t, n) => {
      ...
      em(n) &&
        ...
        (((e) => tm(e) && nm(e) && Bt(we(e, 'mixed'), !0))(n) && !Eb(n.inline, t)) ||
          s.remove(t, !0)
    },
    Db = (e, t, n) => (x(e) ? {name: t, value: null} : {name: e, value: Ku(t, n)}),
    Pb = (e, t) => {
      '' === e.getAttrib(t, 'style') &&
    ...
    Lb = (e, t, n, o, r) => {
      ...
      _b(n.styles, (a, i) => {
        const {name: l, value: d} = Db(i, a, o),
          c = Yu(d, l)
        ;(n.remove_similar || h(d) || !To(r) || Eb(Xu(e, r, l), c)) && e.setStyle(t, l, ''),
          (s = !0)
      }),
        s && Pb(e, t)
    },
    Mb = (e, t, n, o, r) => {
      const s = e.dom,
        a = Ch(e),
        i = e.schema
      if (nm(t) && fs(i, t.inline) && ps(i, o) && o.parentElement === e.getBody())
      ...
      if (nm(t) && 'all' === t.remove && p(d)) {
        ...
        if ((s.removeAllAttribs(l), V(e, (e) => s.setAttrib(l, e.name, e.value)), e.length > 0))
          ...
          _b(t.attributes, (e, o) => {
            ...
            if (t.remove_similar || h(i) || !To(r) || Eb(s.getAttrib(r, a), i)) {
              ...
              if (
                ...
                'style' === a && Do(['li'])(l) && 'none' === s.getStyle(l, 'list-style-type'))
              )
        ...
        u = (t) => {
          ...
          V(['underline', 'line-through', 'overline'], (n) => {
            To(t) &&
              ...
              t.parentNode &&
              Qu(i, t.parentNode) === n &&
              Ib(e, {deep: !1, exact: !0, inline: 'span', styles: {textDecoration: n}}, void 0, t)
          })
        },
        m = (e) => {
          ...
          if (t) {
            ...
            return (
              ((e) => pu(e) && To(e) && ('_start' === e.id || '_end' === e.id))(n) &&
          ...
          if (a.split) {
            if (((r = uf(r)), (n = Rb(e, r, !0)), (o = Rb(e, r)), n !== o)) {
              if (((n = Ab(n, !0)), (o = Ab(o, !1)), Nb(i, n, o))) {
                ...
                return (
                  d(Tb(i, e, !0, 'span', {id: '_start', 'data-mce-type': 'bookmark'})), void m(!0)
                )
              }
              if (Nb(i, o, n)) {
                const e = M.from(o.lastChild).getOr(o)
                return (
                  d(Tb(i, e, !1, 'span', {id: '_end', 'data-mce-type': 'bookmark'})), void m(!1)
                )
              }
              ;(n = Ob(i, n, 'span', {id: '_start', 'data-mce-type': 'bookmark'})),
            ...
            const p = (a) => {
              ...
              if (((o) => ((e) => em(e) && !0 === e.wrapper)(s) && Yh(e, o, t, n))(a)) u = null
                ...
                if (
                  ((t, n, o) => {
                    const r =
                      ((e) => em(e) && !0 !== e.wrapper)(s) && $u(e.schema, t) && Vu(e, n, f)
                    return o && r
                  })(a, w, k)
                ) {
                  ...
                  (s.exact ||
                    ...
                    (a = ((e) => {
                      const t = Q(e.childNodes, Fu).filter(
                        (e) => 'false' !== o.getContentEditable(e) && Kh(o, e, s)
                      )
                      return t
                        .map((t) => {
                          const n = o.clone(t, !1)
                  ...
                  ((e, t, n, o, r) => {
                    ...
                    ;(Yh(e, s, n, o) && Ib(e, t, o, r)) ||
                      (t.merge_with_parents &&
                        s &&
                        e.dom.getParent(s, (s) => !!Yh(e, s, n, o) && (Ib(e, t, o, r), !0)))
                  })(e, s, t, n, a),
                  ((e, t, n, o) => {
                    if (t.styles && t.styles.backgroundColor) {
                      ...
                      Cb(
                        o,
                        (e) => r(e) && Uu(e),
                        xb(e, 'backgroundColor', Ku(t.styles.backgroundColor, n))
                      )
                    }
                  })(o, s, n, a),
                  ((e, t, n, o) => {
      ...
      var T,
        ...
        ke = function (e) {
          ;(Ce && Ce === e) ||
            ...
            (ue = 'ADD_URI_SAFE_ATTR' in e ? Sv(_v(me), e.ADD_URI_SAFE_ATTR) : me),
            (de = 'ADD_DATA_URI_TAGS' in e ? Sv(_v(ce), e.ADD_DATA_URI_TAGS) : ce),
            ...
            e.FORBID_CONTENTS && (ie === le && (ie = _v(ie)), Sv(ie, e.FORBID_CONTENTS)),
            re && (z['#text'] = !0),
      ...
      var Ae = function (e) {
        ...
        Ie = function (e) {
          ...
          return e instanceof l && !Ae(e)
            ? (Oe(e), !0)
            : ('noscript' !== o && 'noembed' !== o) || !wv(/<\/no(script|embed)/i, e.innerHTML)
            ? (X &&
                3 === e.nodeType &&
                ((t = e.textContent),
                (t = vv(t, D, ' ')),
                (t = vv(t, P, ' ')),
                e.textContent !== t &&
                  (pv(n.removed, {element: e.cloneNode()}), (e.textContent = t))),
        ...
        Fe = function (e, t, n) {
          ...
          if (G && !W[t] && wv(L, t));
            ...
            if (
              !(
                (Ue(e) &&
                  ((V.tagNameCheck instanceof RegExp && wv(V.tagNameCheck, e)) ||
                    (V.tagNameCheck instanceof Function && V.tagNameCheck(e))) &&
                  ((V.attributeNameCheck instanceof RegExp && wv(V.attributeNameCheck, t)) ||
                    (V.attributeNameCheck instanceof Function && V.attributeNameCheck(t)))) ||
                ('is' === t &&
                  V.allowCustomizedBuiltInElements &&
                  ((V.tagNameCheck instanceof RegExp && wv(V.tagNameCheck, n)) ||
      ...
      return (
        (n.sanitize = function (e, r) {
          ...
          if ((J || ke(r), (n.removed = []), 'string' == typeof e && (se = !1), se)) {
            ...
            (1 === (l = (a = Be('\x3c!----\x3e')).ownerDocument.importNode(e, !0)).nodeType &&
              'BODY' === l.nodeName) ||
            'HTML' === l.nodeName
              ? (a = l)
              : a.appendChild(l)
  ...
  const ny = (e, t, n) =>
    ...
    ry = (e, t, n = !1) =>
      ny(t, n, (t, n) => M.from(e.getByData(t, n)).orThunk(() => Zv(n, t).map((n) => oy(e, n, t)))),
    sy = Tt.each,
    ay = Tt.trim,
    iy = [
      'source',
      ...
      return (
        ...
        (!!/((java|vb)script|mhtml):/i.test(o) ||
          (!e.allow_html_data_urls &&
            (/^data:image\//i.test(o)
              ? ((e, t) => (C(e) ? !e : !C(t) || !j(dy, t)))(e.allow_svg_data_urls, n) &&
  ...
  class uy {
    ...
    toAbsPath(e, t) {
      ...
      let d
      return (
        (d = l <= 0 ? ne(i).join('/') : a.slice(0, l).join('/') + '/' + ne(i).join('/')),
        0 !== d.indexOf('/') && (d = '/' + d),
  ...
  const my = Tt.makeMap,
      ...
      return (
        n.addHook('uponSanitizeElement', (n, a) => {
          ...
          8 === n.nodeType &&
            ...
            /^\[if/i.test(null !== (i = n.nodeValue) && void 0 !== i ? i : '') &&
          ...
          ;(o.keepAttr = !r || t.isValid(s, a) || ze(a, 'data-') || ze(a, 'aria-')),
            ...
            o.keepAttr
              ? ((o.allowedAttributes[a] = !0),
                ...
                e.allow_svg_data_urls && ze(i, 'data:image/svg+xml') && (o.forceKeepAttr = !0))
              : !n.hasAttribute(hy) ||
                ...
                ((e, n) => {
                  ...
                  if (t.isValidChild(e.name, n.toLowerCase())) {
                    for (; i; ) {
                      ...
                      g(o, i)
                        ? (l ||
                            ((l = new pg(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)),
                          l.append(i))
                        : (d(l), (l = null)),
                        (i = t)
                    }
            ...
            e.addNodeFilter('br', (e, t, o) => {
              ...
              for (let t = 0, l = e.length; t < l; t++) {
                ...
                if (d && r[d.name] && l === d.lastChild) {
                  ...
                  let e = l
                  for (; d && d.firstChild === e && d.lastChild === e && ((e = d), !r[d.name]); )
                    d = d.parent
                  if (e === d) {
            ...
            ((e, t) => {
              ...
              if (n) {
                const t = (e) => {
                  const t = e.attr('src')
                  ;((e) =>
                    e.attr('src') === Nt.transparentSrc || C(e.attr('data-mce-placeholder')))(e) ||
    ...
    xy = (e, t, n) => (n.no_events ? t : Cy(t, (t) => Tm(e, {...n, content: t})).content),
    ky = (e, t) => {
      if (t.no_events) return Wi.value(t)
      {
    ...
    Ky = (e, t) =>
      !(!e || !t) && (!!((e, t) => qy(e) === qy(t))(e, t) || ((e, t) => Wy(e) === Wy(t))(e, t)),
    Gy = (e) => 0 === e.get(),
    Yy = (e, t, n) => {
      Gy(n) && (e.typing = t)
    },
    ...
    Qy = (e) => ({
      ...
      undoManager: {
        ...
        hasUndo: (t, n) =>
          ((e, t, n) => n.get() > 0 || (t.typing && t.data[0] && !Ky($y(e), t.data[0])))(e, t, n),
        hasRedo: (e, t) => ((e, t) => t.get() < e.data.length - 1 && !e.typing)(e, t),
        transact: (e, t, n) =>
          ((e, t, n) => (Xy(e, t), e.beforeChange(), e.ignore(n), e.add()))(e, t, n),
        ignore: (e, t) =>
          ((e, t) => {
            try {
              e.set(e.get() + 1), t()
          ...
          ((e, t) => {
            ...
            return M.from(e.selection.getStart(!0))
              .bind((o) =>
                $h(
                  mn(o),
                  (n) => ce(t, (t) => ((t, n) => (Yh(e, t.dom, n) ? M.some(n) : M.none()))(n, t)),
                  n
                )
              )
              .getOrNull()
      ...
      editor: {
        getContent: (t) =>
          ((e, t) =>
            M.from(e.getBody()).fold(N('tree' === t.format ? new pg('body', 11) : ''), (n) =>
              xg(e, t, n)
            ))(e, t),
        setContent: (t, n) =>
          ((e, t, n) =>
            M.from(e.getBody())
              ...
              .getOr({content: t, html: Uh(n.content) ? '' : n.content}))(e, t, n),
    ...
    oC = (e, t, n, o) => {
      e.bind(
        ...
        const e = ((e, t) => e.filter((e) => _m.isBookmarkNode(e.dom)).bind(t ? En : _n))(t, o)
          .or(t)
          .filter(Ut)
        return e.map((e) =>
          ((e, t) => {
      ...
      const {selectorChangedWithUnbind: a} = ((e, t) => {
        ...
        c = () => {
          ...
          try {
            ...
            e &&
              !Oo(e.anchorNode) &&
              ((n = e.rangeCount > 0 ? e.getRangeAt(0) : i.createRange()), (n = sg(o, [n])[0]))
          } catch (e) {}
        ...
        f = {
          ...
          getContent: (e) =>
            ((e, t = {}) =>
              ((e, t, n) => eC(e).selection.getContent(t, n))(e, t.format ? t.format : 'html', t))(
              o,
              e
            ),
          setContent: i,
              ...
              M.from(t).bind((t) =>
                M.from(t.parentNode).map((o) => {
                  const r = e.nodeIndex(t),
                    s = e.createRng()
                  return (
                    s.setStart(o, r), s.setEnd(o, r + 1), n && (Du(e, s, t, !0), Du(e, s, t, !1)), s
                  )
                })
              ))(e, t, n).each(u),
            t
    ...
    _C = (e) => {
      const t = [],
        ...
        a = (a, i = !0) =>
          e.removed ||
          !((e) => {
            return ((t = e.inline ? e.getBody() : e.getContentAreaContainer()), M.from(t).map(mn))
              .map(Hn)
              .getOr(!1)
            var t
          })(e)
        ...
        findAll: (o, r = L) => {
          const s = K(((e) => (e ? de(e.getElementsByTagName('img')) : []))(o), (t) => {
              ...
              return (
                ...
                (ze(n, 'blob:') ? !e.isUploaded(n) && r(t) : !!ze(n, 'data:') && r(t))
              )
            }),
            a = $(s, (e) => {
              const o = e.src
                      ...
                      : ((o = t),
                        ze(o, 'blob:')
                          ...
                          ? ((r = o),
                            new Promise((e, t) => {
                              Jv(r)
                                .bind(({type: e, data: t, base64Encoded: n}) => Zv(e, t, n))
                                .fold(() => t('Invalid data URI'), e)
                            }))
                          : Promise.reject('Unknown URI format')).then((t) =>
                          ey(t).then((o) => ny(o, !1, (n) => M.some(oy(e, t, n))).getOrThunk(n))
                        )
                  }
                  var o, r
                  return ze(t, 'data:')
  ...
  const UC = (e, t) => {
    ...
    jC = (e, t) => UC(t, {url: El(e), basePath: Nl(e), credentials: Rl(e), handler: Al(e)}),
    HC = (e) => {
      const t = (() => {
        let e = []
        const t = (e) => {
          ...
          (t = e.replace(/(?:([#\.]|::?)([\w\-]+)|(\[)([^\]]+)\]?)/g, (e, t, o, r, s) => {
            switch (t) {
              ...
              case '.':
                ...
                break
              case ':':
                ;-1 !== Tt.inArray('checked disabled enabled read-only required'.split(' '), o) &&
                  (n.attrs[o] = o)
            }
            if ('[' === r) {
              const e = s.match(/([\w\-]+)(?:\=\"([^\"]+))?/)
    ...
    ZC = (e) => {
                  ...
                  ? (p(o) || (o = [o]),
                    V(o, (e) => {
                      v(e.deep) && (e.deep = !tm(e)),
                        ...
                        tm(e) && nm(e) && ((e.mixed = !0), (e.block_expand = !0)),
      ...
      return (
          ...
          })(n, e),
        {
          ...
          match: (t, n, o, r) =>
            ((e, t, n, o, r) => eC(e).formatter.match(t, n, o, r))(e, t, n, o, r),
          closest: (t) => ((e, t) => eC(e).formatter.closest(t))(e, t),
          matchAll: (t, n) => ((e, t, n) => eC(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) =>
            ((e, t, n, o, r) => eC(e).formatter.matchNode(t, n, o, r))(e, t, n, o, r),
          canApply: (t) => ((e, t) => eC(e).formatter.canApply(t))(e, t),
          formatChanged: (t, o, r, s) =>
            ((e, t, n, o, r, s) => eC(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: O(JC, e),
        }
      )
    },
    ...
    tw = (e) => {
      const t = Na(),
        ...
        r = {
          ...
          add: (s, a) =>
            ((e, t, n, o, r, s, a) => eC(e).undoManager.add(t, n, o, r, s, a))(e, r, o, n, t, s, a),
          dispatchChange: () => {
            e.setDirty(!0)
            const t = $y(e)
            ;(t.bookmark = $i(e.selection)),
              e.dispatch('change', {level: t, lastLevel: ae(r.data, o.get()).getOrUndefined()})
          },
            ...
            e.on('init', () => {
              ...
              e.on('keyup', (n) => {
                ...
                n.isDefaultPrevented() ||
                  (((s >= 33 && s <= 36) || (s >= 37 && s <= 40) || 45 === s || n.ctrlKey) &&
                    (r(), e.nodeChanged()),
            ...
            ? ((e, t, n) => {
                ...
                return Dt(o, r, aw).filter(
                  (t) =>
                    ...
                    ((e) => !1 === Yo(e.from.block.dom) && !1 === Yo(e.to.block.dom))(t) &&
                    ((e) => {
    ...
    vw = (e) => {
      ...
      return ((e, t) => {
        ...
        : ((e, t) => {
            const n = t.getRng()
            return Dt(Hp(e, mn(n.startContainer)), Hp(e, mn(n.endContainer)), (o, r) =>
              bn(o, r)
                ? M.none()
                : M.some(() => {
                    n.deleteContents(),
                    ...
                    ((e, t) => {
                      ...
                      ? ((e, t) =>
                          y(t)
                            ...
                            : M.none())(t, n.getNode(!t)).orThunk(() => Ow(e, t, n))
                      : Ow(e, t, n).bind((t) =>
                          ((e, t, n) =>
                            n.fold(
                              (e) => M.some(Aw.remove(e)),
                              (e) => M.some(Aw.moveToElement(e)),
                              (n) => (yc(t, n, e) ? M.none() : M.some(Aw.moveToPosition(n)))
                            ))(e, n, t)
                        ))(e, t, r)
            })(e.getBody(), t, e.selection.getRng()).map(
              (n) => () =>
                n.fold(
                  ((e, t) => (n) => (e._selectionOverrides.hideFakeCaret(), Bp(e, t, mn(n)), !0))(
                    e,
                    t
                  ),
                  ((e, t) => (n) => {
      ...
      e
        ? ((e) => {
            ...
            if (Mw(e.previousSibling))
              return Fw(e.previousSibling) || e.previousSibling.appendData(kr), e.previousSibling
        ...
        : ((e) => {
            var t, n
            if (Mw(e.nextSibling))
              return Iw(e.nextSibling) || e.nextSibling.insertData(0, kr), e.nextSibling
    ...
    tx = (e) => {
      return (
        ...
        !(
          ...
          ((e) => Dp.test(e))(null !== (n = t.textContent) && void 0 !== n ? n : '')
        )
      )
      var t, n
    },
  ...
  const mx = (e, t) => (e === Bc.Backwards ? ne(t) : t),
    ...
    gx = (e, t, n, o) =>
      Wo(o.getNode(t === Bc.Forwards)) ? ux.Br : !1 === yc(n, o) ? ux.Block : ux.Wrap,
    px = (e, t, n, o) => {
      const r = $c(n)
      let s = o
      const a = []
      for (; s; ) {
        ...
        if (Wo(n.getNode(!1)))
          return t === Bc.Forwards
            ? {positions: mx(t, a).concat([n]), breakType: ux.Br, breakAt: M.some(n)}
  ...
  const Bx = (e, t, n, o, r, s) => {
    ...
    Yx = (e, t, n) =>
      ...
      ((e, t) => {
        ...
        return (
          ...
          (e && Br(o) ? cx(!0, t.selection, o) : !(e || !Dr(o)) && cx(!1, t.selection, o))
        )
      })(e, t),
    Xx = (e) => {
      const t = Ca(null),
    ...
    tk = (e, t, n, o) => {
      ...
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          zp(e),
          nx(s, r, xi.fromRangeStart(e.selection.getRng())).map(ax).bind(ek(e, t)).each(D)
      }),
        e.nodeChanged()
    },
    nk = (e, t, n) => {
    ...
    hk = (e, t, n) =>
      ce([pk, Pw, Ew, (e, n) => nk(e, t, n), hw, hh, Lw, ik, yw, sk], (t) => t(e, n)),
    bk = (e, t) => {
      e.addCommand('delete', () => {
        ;((e, t) => {
          hk(e, t, !1).fold(() => {
    ...
    Nk = (e, t) => {
      t.hasAttribute('data-mce-caret') &&
        (Mr(t), e.selection.setRng(e.selection.getRng()), e.selection.scrollIntoView(t))
    },
    Rk = (e, t) => {
      const n = ((e) =>
    ...
    jk = (e, t) =>
      Q(
        ((e, t) => ee(((e) => $(e, (e) => ({...Fk, ...e})))(e), (e) => (Uk(e, t) ? [e] : [])))(
          e,
          t
        ),
        (e) => e.action()
    ...
    Jk = (e, t = !1) => {
      return Hn(e)
        ...
        : ((n = e), Eo(n, '[contenteditable]')).fold(N(t), (e) => 'true' === Zk(e))
      var n
    },
    ...
    oS = (e, t, n) => {
      ...
      return ((e) => e.breakType === ux.Wrap && 0 === e.positions.length)(o) ||
        (!Wo(n.getNode()) && ((e) => e.breakType === ux.Br && 1 === e.positions.length)(o))
      ...
      if (!t && rS(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() => ie(n.getClientRects()).bind((n) => bx(wx(e, xi.before(t)), n.left)))
      ...
      if (t && sS(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() => ie(n.getClientRects()).bind((n) => bx(xx(e, xi.after(t)), n.left)))
      ...
      return ((e, t) =>
        ((e, t, n = P) =>
          n(t)
            ...
            : j(e, Lt(t))
            ? M.some(t)
            : So(t, e.join(','), (e) => pn(e, 'table') || n(e)))(['td', 'th'], e, t))(
                ...
                return !((e, t) => {
                  ...
                  const o =
                    null !== (n = e.getParent(t.container, e.isBlock)) && void 0 !== n
                      ? n
                      : e.getRoot()
                  return xS(e, t.container, t.offset, (e, t) => (0 === t ? -1 : t), o)
                    .filter((e) => {
  ...
  const TS = (e, t, n) => (e.stype === OS.Error ? t(e.serror) : n(e.svalue)),
    ...
    IS = (e, t) => ({
      extract: (n, o) =>
        we(o, e).fold(
          () =>
            ((e, t) => MS(e, () => 'Choice schema did not contain choice key: "' + t + '"'))(n, e),
          (e) =>
            ((e, t, n, o) =>
              we(n, o).fold(
                () =>
                  ((e, t, n) =>
                    MS(
                      e,
                      () => 'The chosen schema: "' + n + '" did not exist in branches: ' + LS(t)
                    ))(e, n, o),
          ...
          e.fold(
            ...
            (e) => {
              ...
              return (
                (s = n),
                (a = M.some),
                s.stype === OS.Value ? {stype: OS.Value, svalue: a(s.svalue)} : s
              )
              var s, a
            }
          )
        ...
        case 'required':
          return ((e, t, n, o) =>
            we(t, n).fold(
              () =>
                ((e, t, n) =>
                  MS(e, () => 'Could not find valid *required* value for "' + t + '" in ' + LS(n)))(
                  e,
                  n,
                  t
                ),
    ...
    YS = (e, t, n) => {
      return (
        (o = ((e, t, n) =>
          ((e, t) => (e.stype === OS.Error ? {stype: OS.Error, serror: t(e.serror)} : e))(
            t.extract([e], n),
            (e) => ({input: n, errors: e})
          ))(e, t, n)),
        ...
        ((e) => {
          return (
            (t = (t) =>
              j(e, t)
                ? Wi.value(t)
                : Wi.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`)),
            $S((e) => t(e).fold(DS, BS))
          )
          var t
        })(n)
  ...
  KS(
    [
      ...
      g_('initValue', N('')),
      x_,
      ((e, t) => o_(e, e, {tag: 'required', process: {}}, GS(t)))('commands', M_),
      l_('launch', XS('type', {contextformbutton: P_, contextformtogglebutton: L_})),
    ].concat(T_)
  )
  const I_ = (e) => {
      ...
      const t = Na(),
        ...
        a = (a) => {
          ;((n) =>
            t
              .get()
              .map((t) => ES(e.dom, e.selection.getRng(), t.trigger).bind((t) => AS(e, s, t, n)))
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng()
                  return ((e, t, n) => ce(n.triggers, (n) => ES(e, t, n)))(e.dom, o, n).bind((n) =>
                    AS(e, t, n)
                  )
                })(e, s)
              ))(a).fold(r, (s) => {
      ...
      insert: (e, t) => {
        ...
        const i = e.dom,
          ...
          g = (e) => {
            ...
            let s
            for (
              zo(n) && (e && 0 === t ? r.prev() : e || t !== n.data.length || r.next());
              (s = r.current());
        ...
        if (Rr(w)) (S = Mr(w)), i.isEmpty(w) && X_(w), eE(e, S), H_(e, S)
          ...
          const t = ((e) => {
            const t = e.cloneRange()
            return (
              t.setStart(e.startContainer, Z_(!0, e.startContainer, e.startOffset)),
          ...
          ;((e) => {
            ...
            ((e, t) => {
              t.normalize()
              const n = t.lastChild
              ;(!n || (To(n) && /^(left|right)$/gi.test(e.getStyle(n, 'float', !0)))) &&
                e.add(t, 'br')
            })(i, w),
            i.isEmpty(w) && X_(w),
            S.normalize(),
    ...
    NE = (e, t, n) => {
      n && !e.get() ? t.on('NodeChange', _E, !0) : !n && e.get() && t.off('NodeChange', _E),
        e.set(n)
    },
    RE = (e, t) => {
      const n = t.container(),
          ...
          .map(
            (o) => () =>
              TE(
                n,
                t
              )(o).each(((e) => (t) => (e.selection.setRng(t.toRange()), e.nodeChanged(), !0))(e))
          )
      }
      return M.none()
    },
                ...
                ((e, t, n) => {
                  ...
                  jk(
                    [
                      ...
                      ...(o
                        ? [
                            {keyCode: Dm.UP, action: zk(Pk, e, !1), metaKey: !0, shiftKey: !0},
                            {keyCode: Dm.DOWN, action: zk(Pk, e, !0), metaKey: !0, shiftKey: !0},
                          ]
                        : []),
                      ...
                      {keyCode: Dm.LEFT, ctrlKey: !o, altKey: o, action: zk(Jx, e, t)},
          ...
          ((e, t) => {
            e.on('keydown', (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  const o =
                    n.keyCode === Dm.BACKSPACE ? 'deleteContentBackward' : 'deleteContentForward'
                  Hk(
                    [
              ...
              t.isDefaultPrevented() ||
                ((e, t) => {
                  Hk([{keyCode: Dm.SPACEBAR, action: zk(BE, e)}], t).each((n) => {
                    t.preventDefault(),
                      j_(e, 'insertText', {data: ' '}).isDefaultPrevented() ||
                  ...
                  jk(
                    [
                      ...
                      ...(o
                        ? []
                        : [
                            {keyCode: Dm.HOME, action: zk(Pk, e, !1), ctrlKey: !0, shiftKey: !0},
  ...
  const ME = N('x-tinymce/html'),
    ...
    XE = (e, t, n) =>
      !!((e, t) => GE(t) && H(jd(e), (e) => je(t.toLowerCase(), `.${e.toLowerCase()}`)))(e, t) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t)
    ...
    rN = (e, t, n) => {
      ...
      if (_d(e) && o) {
        const s = ((e, t) => {
          const n = t.items
              ? ee(de(t.items), (e) => ('file' === e.kind ? [e.getAsFile()] : []))
              : [],
        ...
        if (s.length > 0)
          return (
            t.preventDefault(),
            ((r = s), Promise.all($(r, (e) => ey(e).then((t) => ({file: e, uri: t}))))).then(
              (t) => {
    ...
    aN = (e, t, n) => {
      ;((e, t, n) => {
        let o
        e.on('keydown', (e) => {
          ;((e) => (Dm.metaKeyPressed(e) && 86 === e.keyCode) || (e.shiftKey && 45 === e.keyCode))(
            e
          ) &&
            !e.isDefaultPrevented() &&
      ...
      ;((e) => {
        ...
        ((e, t) => {
          e.addCommand('mceTogglePlainTextPaste', () => {
            ;((e, t) => {
              'text' === t.get() ? (t.set('html'), Bm(e, !1)) : (t.set('text'), Bm(e, !0)),
                e.focus()
            })(e, t)
          }),
    ...
    kN = (e) => {
      const t = ((e, t) => {
        const n = xi.fromRangeStart(e).getNode(),
          o = ((e, t) => ko(mn(e), (e) => ((e) => Go(e.dom))(e) || dr(e), CN(t)).getOr(mn(t)).dom)(
            n,
            t
          ),
          r = xN(n, o, !1),
  ...
  const _N = (e, t) => Math.abs(e.left - t),
    ...
    AN = (e, t, n) => {
      const o = (e) =>
          Wr(e.node) ? M.some(e) : To(e.node) ? AN(de(e.node.childNodes), t, n) : M.none(),
        r = (e, r) => {
    ...
    ON = (e, t, n) =>
      ((e, t, n) => {
        ...
        .filter((e) => rc(e.node))
        .map((e) =>
          ((e, t) => ({node: e.node, position: _N(e, t) < EN(e, t) ? SN.Before : SN.After}))(e, t)
        ),
    TN = (e) => {
      var t, n
          ...
          if (e.dragging) {
            const s = r.currentTarget === t.getDoc().documentElement,
              l = ((e, t) => ({pageX: t.pageX - e.relX, pageY: t.pageY + 5}))(
                ...
                ((e, t) => {
                  return (
                    (n = ((e) => (e.inline ? TN(e.getBody()) : {left: 0, top: 0}))(e)),
                    (o = ((e) => {
                      const t = e.getBody()
        ...
        a = ((e, t) => (n) => {
          e.on((e) => {
            if ((e.intervalId.clear(), e.dragging)) {
              if (
                ((e, t, n) => !y(t) && t !== n && !e.dom.isChildOf(t, n) && !BN(t))(
                  t,
                  ((e) => {
                    const t = e.getSel()
                    if (C(t)) {
          ...
          e.on('mousedown', (r) => {
            ...
            VN(a)
              ...
              : ON(o, r.clientX, r.clientY).each((n) => {
                  var o
                  r.preventDefault(),
                    (o = d(1, n.node, n.position === SN.Before, !1)) && t.setRng(o),
                  ...
                  const t = (t) => {
                      if (!t.isDefaultPrevented()) {
                        ...
                        n &&
                          ...
                          (t.preventDefault(),
                          'drop' === t.type && OC(e, 'Dropped file type is not supported'))
                      }
                    },
                    n = (n) => {
                      Gf(e, n.target) && t(n)
    ...
    YN = (e, t, n, o, r, s, a = !1) => ({start: GN(e, t, n, o, a), end: GN(e, t, r, s, a)}),
    XN = (e, t) => {
      const n = t.slice(),
        o = n.pop()
      return x(o)
        ? Y(n, (e, t) => e.bind((e) => M.from(e.childNodes[t])), M.some(e)).bind((e) =>
            zo(e) && (o < 0 || o > e.data.length) ? M.none() : M.some({node: e, offset: o})
          )
        : M.none()
    },
    QN = (e, t) =>
    ...
    ZN = (e, t, n, o = !0) => {
      ...
      t.deleteContents(),
        o &&
          !n(t.startContainer) &&
          (zo(t.startContainer) && 0 === t.startContainer.data.length && e.remove(t.startContainer),
          zo(t.endContainer) && 0 === t.endContainer.data.length && e.remove(t.endContainer),
          JN(e, r, n),
          r !== s && JN(e, s, n))
    },
    ...
    dR = (e, t, n, o) => {
      ...
      return xS(
        ...
        if (-1 !== i && o.offset >= i + r.length) {
          const t = e.createRng()
          return (
            t.setStart(o.container, o.offset - r.length), t.setEnd(o.container, o.offset), M.some(t)
          )
        }
        {
    ...
    cR = (e, t, n, o) => {
      ...
      return CS(i, l - n.pattern.end.length, t).bind((d) => {
        ...
        if (lR(a)) return M.some({matches: [{pattern: a, startRng: c, endRng: c}], position: d})
        {
          ...
          return m.map((e) => {
            const t = ((e, t, n, o = !1) =>
              YN(e, t, n.startContainer, n.startOffset, n.endContainer, n.endOffset, o))(r, s, e, o)
            return {
    ...
    fR = (e, t, n, o, r, s) => {
      ...
      return ((e, t) => {
        ...
        uR(
          e,
          ((a = r.inlinePatterns), se(a, (e, t) => t.end.length - e.end.length)),
          n,
          o,
          t,
          s
              ...
              return ((e, t) => {
                ...
                .map((e) =>
                  Tt.trim(i).length === e.start.length
                    ? []
                    : [{pattern: e, range: YN(s, s.getRoot(), t, 0, t, 0, true)}]
                )
                .getOr([])
            })(e, o, a)
          return (
    ...
    ER = (e) => {
              ...
              const t = [',', '.', ';', ':', '!', '?'],
                ...
                o = () => {
                  return (
                    (t = Ld(e)),
                    (n = Md(e)),
                    {inlinePatterns: Ji(t), blockPatterns: Qi(t), dynamicPatternsLookup: n}
                  )
                  var t, n
                },
        ...
        ((e) => {
          ...
          const n = e.dom,
            ...
            s = (t, a) => {
              if (
                ((e) => {
                  if (rw(e)) {
                    ...
                    return (
                      !sw(e) &&
                      (Dm.metaKeyPressed(e) || e.altKey || (t >= 112 && t <= 123) || j(nw, t))
                    )
                  }
                  return !1
                })(t)
              ...
              const i = e.getBody(),
                l =
                  !((e) => rw(e) && !(sw(e) || ('keyup' === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
                    if (os(mn(t), !1)) {
      ...
      ;((e) => {
        ...
        ;((e) => {
          ...
          xd(e) || ((t.body.spellcheck = !1), vR.setAttrib(n, 'spellcheck', 'false')),
          (e.quirks = bR(e)),
          ((e) => {
        ...
        ((e) => {
          ...
          if (m(t)) {
            ...
            ;(e.theme = n(e, NC.urls[t]) || {}),
              w(e.theme.init) && e.theme.init(e, NC.urls[t] || e.documentBaseUrl.replace(/\/$/, ''))
          } else e.theme = {}
        })(e),
        ((e) => {
          const t = Gl(e),
                ...
                ;(r.onload = () => {
                  ...
                  (e.iframeHTML = ((e) => {
                    ...
                    return (
                      ml(e) &&
                        (t +=
                          '<meta http-equiv="Content-Security-Policy" content="' + ml(e) + '" />'),
        ...
        ((e, t, n) => {
          const o = LR(t, 'default', n),
            r = ((e) =>
              M.from(_l(e))
                .filter(We)
                .map((e) => ({url: e, name: M.none()})))(t).orThunk(() => LR(t, Sl(t), ''))
          V(
            ((e) => {
              const t = [],
                n = (e) => {
        ...
        .bind((n) =>
          ((e, t, n) =>
            $h(
              ...
              (t) =>
                ((t) =>
                  Gn(t, e).orThunk(() => (XR(t) ? we(YR, e).bind((e) => Kt(t, e)) : M.none())))(t),
              (e) => bn(mn(t), e)
            ))(e, t, n.dom).or(((e, t) => M.from(ba.DOM.getStyle(t, e, !0)))(e, n.dom))
        )
        .getOr(''),
    JR = QR('font-size'),
                ...
                e.removed ||
                  (t
                    ...
                    : ((e) => {
                        ...
                        e.inline || (Nt.browser.isOpera() || Jf(n), e.getWin().focus()),
                          (Nt.browser.isFirefox() || e.inline) && (Jf(n), Qf(e, o)),
                          eg(e)
                      })(e))
              })(e, !0 === o)
            },
        ...
        : mA(e) &&
          ((e, t) => {
            if (((e) => 'click' === e.type)(t) && !Dm.metaKeyPressed(t)) {
              const n = mn(t.target)
              ;((e, t) => Eo(t, 'a', (t) => bn(t, mn(e.getBody()))).bind((e) => Kt(e, 'href')))(
                e,
                n
              ).each((n) => {
                if ((t.preventDefault(), /^#/.test(n))) {
                  const t = e.dom.select(
                    `${n},[name="${
                      ((o = n), ze(o, '#') ? ((e, t) => e.substring(t))(o, '#'.length) : o)
                    }"]`
                  )
        ...
        'focus' !== e &&
          ...
          (n.removed ||
            (t
              ...
              : n.initialized &&
                n.delegates &&
                (n.dom.unbind(wA(n, e), e, n.delegates[e]), delete n.delegates[e])))
      },
    ...
    LA = (e) => {
      ...
      TA(BA(e.toLowerCase(), '+'), (e) => {
        ;((e) => e in PA)(e)
          ...
          : ((t.charCode = e.charCodeAt(0)), (t.keyCode = DA[e] || e.toUpperCase().charCodeAt(0)))
      })
      const o = [t.keyCode]
      let r
  ...
  class MA {
    ...
    createShortcut(e, t, n, o) {
      ...
      return (
        (r[r.length - 1] = Tt.extend(r[r.length - 1], {func: n, scope: o || this.editor})),
  ...
  class jA {
      ...
      ;(this.options = ((e, t) => {
        const n = {},
          ...
          r = (e, t, n) => {
            ...
            return NA(r)
              ? ((o[e] = r.value), !0)
              : (console.warn(EA(`Invalid value passed for the ${e} option`, r)), !1)
          },
          s = (e) => xe(n, e)
        return {
          register: (e, s) => {
        ...
        ((e) => {
          ...
          t('id', {processor: 'string', default: e.id}),
            ...
            e.on('ScriptsLoaded', () => {
              t('directionality', {processor: 'string', default: Sa.isRtl() ? 'rtl' : void 0}),
                t('placeholder', {
                  processor: 'string',
      ...
      ;((e) => {
        ...
        e.on('remove', () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) =>
            ws.forElement(e, {contentCssCors: cd(t), referrerPolicy: Tl(t)}))(o, e)),
          nd(e)
            ? (e.inline = !0)
    ...
    hide() {
      ...
      e.hidden ||
        ...
        e.inline
          ...
          : (FA.hide(e.getContainer()), FA.setStyle(e.id, 'display', e.orgDisplay)),
        (e.hidden = !0),
        e.dispatch('hide'))
    }
    isHidden() {
    ...
    resetContent(e) {
      void 0 === e ? cC(this, this.startContent, {format: 'raw'}) : cC(this, e),
    ...
    getContainer() {
      const e = this
      return (
        e.container || (e.container = e.editorContainer || FA.get(e.id + '_parent')), e.container
      )
    }
      ...
      ;((e) => {
        if (!e.removed) {
          ...
          o && e.save({is_removing: !0}),
            ...
            e.hasHiddenInput && C(null == r ? void 0 : r.nextSibling) && pC.remove(r.nextSibling),
            ((e) => {
              e.dispatch('remove')
            })(e),
  ...
  const KA = (e) => {
    ...
    YA = (e) => {
      ...
      return (
        (WA = K(WA, (t) => e !== t)),
        QA.activeEditor === e && (QA.activeEditor = WA.length > 0 ? WA[0] : null),
    ...
    QA = {
          ...
          HA.unbind(window, 'ready', s),
            ...
            Tt.each(i, (e) => {
              ...
              ;(n = t.get(e.id)) &&
                ...
                (YA(n), n.unbindAllNativeEvents(), n.destroy(!0), (n.removed = !0))
            }),
            ...
            0 === i.length
              ...
              : $A(i, (s) => {
                  ;((e, t) => e.inline && t.tagName.toLowerCase() in o)(e, s)
                    ? DC('Could not initialize inline editor on invalid inline target element', s)
                    : ((e, o, s) => {
            ...
            return (
              ...
              h(t.get(n.id))
                ...
                : (YA(n) && t.dispatch('RemoveEditor', {editor: n}),
                  0 === WA.length && window.removeEventListener('beforeunload', VA),
                  n.remove(),
                  GA(WA.length > 0),
                  n)
            )
      ...
      _setBaseUrl(e) {
        ;(this.baseURL = new uy(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, ''))),
  ...
  try {
    ...
    aO = (() => {
      ...
      return (
        Object.defineProperty(n, 'length', {get: () => t.length, configurable: !1, enumerable: !1}),
        n
      )
    })()
  }
